...
public class ComponentJsonParser implements JsonObjectParser<Component> {
    ...
    public Component parse(JSONObject json) throws JSONException {
        ...
        try {
            return new Component(new URI(basicComponent.getSelf().toString()), basicComponent.getId(), basicComponent.getName().toString(), basicComponent.getDescription().toString(), lead, assigneeInfo);
