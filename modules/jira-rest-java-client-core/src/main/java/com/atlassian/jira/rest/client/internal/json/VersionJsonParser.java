...
public class VersionJsonParser implements JsonObjectParser<Version> {
    ...
    public Version parse(JSONObject json) throws JSONException {
        ...
        return new Version(id, name, description, self.toString(), isArchived, isReleased, Instant.ofEpochMilli(releaseDate != null ? releaseDate.getMillis() : 0).atZone(ZoneId.systemDefault()).toLocalDateTime());
    }
